...
package_load(c("data.table", "rjags", "ggplot2", "doParallel", "lubridate", "VGAMdata", "gridExtra"))
...
if(Sys.getenv("source_dir")=="") {
  ...
  source_dir <- Sys.getenv("main_dir")
  hhsize_dir <- Sys.getenv("nmcp_manu_dir") 
